...
Feature: Verify the Redeem voucher functionality for Gift
Scenario: For gift voucher redeem functionality
...
And I should see "You have given a Gift Voucher to claim!"
And I fill in "product_sku" with "P14UPJ"
And I click the "#claim" element
And I wait 5 seconds
